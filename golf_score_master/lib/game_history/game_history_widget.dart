...
class _GameHistoryWidgetState extends State<GameHistoryWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameHistoryModel());
  }
                ...
                StreamBuilder<List<GamesRecord>>(
                  stream: queryGamesRecord(
                    queryBuilder: (gamesRecord) =>
                        gamesRecord.orderBy('TIME', descending: true),
                  ),
                      ...
                      itemBuilder: (context, listViewIndex) {
                        ...
                        return Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                listViewGamesRecord.player1Score.toString(),
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                            ),
                            Expanded(
                              child: Text(
                                listViewGamesRecord.totalPar.toString(),
                                style: FlutterFlowTheme.of(context).bodyMedium,
                              ),
                            ),
                          ],
